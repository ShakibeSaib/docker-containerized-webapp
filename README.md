...
```powershell
ssh -i ".\Shakibe_SSH.pem" devops@13.223.44.81
```
...
# 33. What Could Be Improved?

This project is intentionally the first step.
...
These limitations are intentional because they give us a path for the next projects.
...
* Created an Ubuntu EC2 environment
...
* Added a Docker restart policy
* Configured AWS Security Group access
* Exposed the application through the EC2 public IP
* Tested the application locally
* Tested the application externally
...
**Project:** `devops-containerized-webapp`

**Status:** ✅ Dockerized web application deployed and accessible through AWS EC2.
